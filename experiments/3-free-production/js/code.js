  ...
  slides.bird_intro = slide({
		...
		present : _.shuffle(stimuli),
		  ...
		  //   var scenes = _.sample([
			...
			var sentenceorder = _.shuffle(["the_is","the_not","a_is","a_not"]); 
   ...
   //      	      }
	   ...
	   button : function() {
	    ...
	    log_responses : function() {
	      exp.data_trials.push({
	       	  "scene": this.stim.scene.label,
	          "animal1" : this.stim.animal1,
	          "color1" : this.stim.color1,
	          "animal2" : this.stim.animal2,
	          "color2" : this.stim.color2,
			  "response" : $("#response").val(),
	          "slide_number" : exp.phase
	      });
	  }
